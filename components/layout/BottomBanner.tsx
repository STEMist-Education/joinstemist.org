...
export default function() {
    ...
    return show && (
        <div className="fixed bottom-0 left-0 bg-slate-50 w-screen h-20 z-40 shadow-inner"> 
            <p className="text-2xl font-bold text-center text-[#2e2e2e]">Upcoming Summer Class!</p>
